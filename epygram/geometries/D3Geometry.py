...
class D3ProjectedGeometry(D3RectangularGridGeometry):
    ...
    def xy2ll(self, x, y):
        ...
        mask = numpy.logical_or(lons == invalid_val, lats == invalid_val)
    ...
    def map_factor_field(self, position=None):
        ...
        kwargs_geom = dict(structure='H2D',
                           ...
                           projection=copy.copy(self.projection),
                           vcoordinate=vcoordinate,
                           position_on_horizontal_grid=self.position_on_horizontal_grid if position is None else position,
                           geoid=copy.copy(self.geoid))
...
class D3GaussGeometry(D3Geometry):
    ...
    def point_is_inside_domain_ij(self, i, j, margin=-0.1):
        ...
        dimensions = as_numpy_array(self.dimensions['lon_number_by_lat'])
        #Firstly we test the validity of j. In case j is invalid result will be False
